...
# Auto Update
$script:MSG_AUTO_UPDATE_ENABLED = "Outomatiese opdaterings geaktiveer"
$script:MSG_AUTO_UPDATE_DISABLED = "Outomatiese opdaterings gedeaktiveer"
$script:MSG_AUTO_UPDATE_INVALID_FREQ = "Ongeldige frekwensie vir outomatiese opdatering"
$script:MSG_AUTO_UPDATE_SUPPORTED = "Ondersteunde waardes: hourly, every3hours, every6hours, daily, weekly, monthly"
