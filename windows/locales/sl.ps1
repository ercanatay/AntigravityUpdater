...
# Auto Update
$script:MSG_AUTO_UPDATE_ENABLED = "Samodejne posodobitve omogocene"
$script:MSG_AUTO_UPDATE_DISABLED = "Samodejne posodobitve onemogocene"
$script:MSG_AUTO_UPDATE_INVALID_FREQ = "Neveljavna pogostost samodejnega posodabljanja"
$script:MSG_AUTO_UPDATE_SUPPORTED = "Podprte vrednosti: hourly, every3hours, every6hours, daily, weekly, monthly"
