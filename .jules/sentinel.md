...
**Prevention:** Perform all integrity and security checks on the new artifact (e.g., inside the mounted DMG) *before* touching the existing installation. Enforce strict exit on verification failure.
