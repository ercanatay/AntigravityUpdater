...
# Auto Update
$script:MSG_AUTO_UPDATE_ENABLED = "เปิดใช้งานการอัปเดตอัตโนมัติแล้ว"
$script:MSG_AUTO_UPDATE_DISABLED = "ปิดใช้งานการอัปเดตอัตโนมัติแล้ว"
$script:MSG_AUTO_UPDATE_INVALID_FREQ = "ความถี่การอัปเดตอัตโนมัติไม่ถูกต้อง"
$script:MSG_AUTO_UPDATE_SUPPORTED = "ค่าที่รองรับ: hourly, every3hours, every6hours, daily, weekly, monthly"
