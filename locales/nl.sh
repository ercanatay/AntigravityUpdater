...
# Auto Update
MSG_AUTO_UPDATE_ENABLED="✅ Automatische updates ingeschakeld"
MSG_AUTO_UPDATE_DISABLED="✅ Automatische updates uitgeschakeld"
MSG_AUTO_UPDATE_INVALID_FREQ="❌ Ongeldige frequentie voor automatische updates"
MSG_AUTO_UPDATE_SUPPORTED="Ondersteunde waarden: hourly, every3hours, every6hours, daily, weekly, monthly"
# New Features (v1.7.0)
