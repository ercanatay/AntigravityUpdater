...
# Auto Update
$script:MSG_AUTO_UPDATE_ENABLED = "自动更新已启用"
$script:MSG_AUTO_UPDATE_DISABLED = "自动更新已禁用"
$script:MSG_AUTO_UPDATE_INVALID_FREQ = "无效的自动更新频率"
$script:MSG_AUTO_UPDATE_SUPPORTED = "支持的值: hourly, every3hours, every6hours, daily, weekly, monthly"
